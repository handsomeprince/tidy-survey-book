...
The word **function** should be **factor** in the following sentence. "The `dplyr::glimpse()` function produces a list of all variables, their types (e.g., factor, double), and a few example values."
